This repository contains the original PyTorch implementation of the paper "**[Rethinking encoder-decoder architecture using vision transformer for colorectal polyp and surgical instruments segmentation
